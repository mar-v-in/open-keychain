...
public class PgpImportExport {
    ...
    public ImportKeyResult importKeyRings(List<ParcelableKeyRing> entries, List<KeyRingInfoEntry> infos) {
        return importKeyRings(entries.iterator(), infos != null ? infos.iterator() : null, entries.size());
    }

    public ImportKeyResult importKeyRings(Iterator<ParcelableKeyRing> entries, Iterator<KeyRingInfoEntry> infos, int num) {
